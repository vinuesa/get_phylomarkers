...
knitr::opts_chunk$set(fig.align = "center", out.height = '1200px', out.width = '0.33\\textheight'); # <<< this is nice to avoid excessively large figures, particularly in the PDF output
```
