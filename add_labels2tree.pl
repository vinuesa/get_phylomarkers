...
my $VERSION = 1.6; # June 12th, 2022; fixed regexes for ASTRAL (topology-only) tree; updated POD and HELP
...
This documentation refers to <add_labels2tree.pl> version 1.6
 
 
=head1 USAGE
 
    usage: run from within the directory containing the tree files, providing two args: 
    1.- my tsv conversion table | my_alignment | Fasta_File.faa  
...
Copyright (c) <2022> <Pablo Vinuesa> (<vinuesa@ccg.unam.mx>). All rights reserved.
