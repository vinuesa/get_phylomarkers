...
# ok( eval{ `bash ./hcluster_pangenome_matrix.sh 2>&1` } =~ /synopsis/, 'hcluster_pangenome_matrix.sh' );
...
# test 16 default run on DNA sequence ...
...
# test 17 IQT run on proteins sequence ...
ok( eval{ `cd test_sequences/core_genome && ../../run_get_phylomarkers_pipeline.sh -R 1 -t PROT -k 1.2 -m 0.6 | grep "wrote file" && rm -rf get_phylomarkers_run_*` }, 'run_get_phylomarkers_pipeline.sh -R 1 -t PROT -k 1.2 -m 0.6' ); 
