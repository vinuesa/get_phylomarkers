 ...
 * 
 * RCS $Id: gki.c 293 2014-02-28 18:37:03Z fabian $ (Original squid RCS Id: gki.c,v 1.3 2000/12/21 23:42:59 eddy Exp)
 */
...
GKIStoreKey(GKI *hash, char *key)
{
  ...
  val = gki_hashvalue(hash, key); if(val<0){val=0;} /* problem for multi-byte characters, FS 291-> */
