...
This repository hosts the code for the *GET_PHYLOMARKERS* software package used to estimate species trees from a supermatrix of concatenated, top-scoring alignments. This file describes its aim and provides usage instructions. A detailed manual is in preparation. 
...
### v) On tree searching: 
#### 1. ModelFinder + IQ-TREE searches:
